...
func TestPrintFloats(t *testing.T) {
	...
	assert.Equalf("1.00", GetFloatsIn2Decimals(1.0), "PrintFloatsIn2Decimals(1) should be '1.00'")
	...
	// assert.Equalf("1.00", GetFloatsIn2Decimals(MyFloat(1.0)), "PrintFloatsIn2Decimals(1) should be '1.00'")
